...
eStatusCode gtt25_baseobject_set_property_number(gtt_device* device, uint16_t ObjectID, uint16_t PropertyID, gtt_number Value)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_BaseObject_SetPropertyNumber);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeU16(device,PropertyID);
	gtt_packetbuilder_writeNumber(device,Value);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_baseobject_get_property_number(gtt_device* device, uint16_t ObjectID, uint16_t PropertyID, gtt_number* out_Value)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_BaseObject_GetPropertyNumber);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeU16(device,PropertyID);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_visualobject_add_object_dependency(gtt_device* device, uint16_t ObjectID, uint16_t TargetObjectID)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_VisualObject_AddObjectDependency);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeU16(device,TargetObjectID);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_gttmodule_screen_shot(gtt_device* device, gtt_text  FileName)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_GTTModule_ScreenShot);
	gtt_packetbuilder_writeText(device,FileName);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_gttmodule_start_comms_log(gtt_device* device)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_GTTModule_StartCommsLog);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_gttmodule_stop_comms_log(gtt_device* device)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_GTTModule_StopCommsLog);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_dataset_initialize(gtt_device* device, uint16_t ObjectID)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_DataSet_Initialize);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_dataset_set_data(gtt_device* device, uint16_t ObjectID, uint16_t Index, gtt_number Value)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_DataSet_SetData);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeU16(device,Index);
	gtt_packetbuilder_writeNumber(device,Value);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_dataset_push_data(gtt_device* device, uint16_t ObjectID, gtt_number Value)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_DataSet_PushData);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeNumber(device,Value);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_dataset_save(gtt_device* device, uint16_t ObjectID, gtt_text  FileName)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_DataSet_Save);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeText(device,FileName);
	gtt_packetbuilder_end(device);
...
eStatusCode gtt25_dataset_load(gtt_device* device, uint16_t ObjectID, gtt_text  FileName)
{
	...
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_DataSet_Load);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeText(device,FileName);
	gtt_packetbuilder_end(device);
...
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_DataSet_Mode,(uint8_t*)result);
}

eStatusCode gtt25_set_dataset_mode(gtt_device * device, uint16_t ObjectID, eDataSetMode value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_DataSet_Mode,value);
}

eStatusCode gtt25_get_dataset_length(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_DataSet_Length,(uint16_t*)result);
}

eStatusCode gtt25_set_dataset_length(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_DataSet_Length,value);
}

eStatusCode gtt25_get_dataset_default_value(gtt_device * device, uint16_t ObjectID, gtt_number* result)
{
	return gtt25_baseobject_get_property_number(device,ObjectID,ePropertyID_DataSet_DefaultValue,(gtt_number*)result);
}

eStatusCode gtt25_set_dataset_default_value(gtt_device * device, uint16_t ObjectID, gtt_number value)
{
	return gtt25_baseobject_set_property_number(device,ObjectID,ePropertyID_DataSet_DefaultValue,value);
}

eStatusCode gtt25_get_dataset_data_count(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_DataSet_DataCount,(uint16_t*)result);
}

eStatusCode gtt25_set_dataset_data_count(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_DataSet_DataCount,value);
}
